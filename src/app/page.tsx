...
const Page = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center pt-10 pb-10 px-6 sm:px-12 md:px-28 mt-20">
      <button
        ...
        <ul>
          {todos.map((todo: ITodo) => (
            ...
            >
              ...
              >
                <span
                  className={`w-fit rounded-2xl px-2 py-1 flex items-center gap-2 bg-white ${
                    todo?.completed ? "bg-green-100" : "bg-orange-100"
                  }`}
                >
                  {todo?.completed ? (
